...
function baseCourse(seed: BuiltInCourseSeed): AcademyCourse {
  ...
  return {
    ...
    coverImage: null,
    description: block(
      `${seed.excerpt} This DayTradingPost version condenses the CMT-style body of knowledge into a direct, guided course focused on practical chart reading, strategy design and risk-aware execution.`,
    ),
