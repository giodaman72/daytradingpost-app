  ...
  return (
    <main className="dashboard-error-state">
      <div>
        ...
        <p>Your account is safe. Try loading the dashboard again or return to your account.</p>
        <div>
          <button className="button" type="button" onClick={reset}>Try again</button>
          <Link href="/account" className="button button-secondary">Go to account</Link>
        </div>
      </div>
    </main>
  );
