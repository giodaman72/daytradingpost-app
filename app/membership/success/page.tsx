...
export const metadata: Metadata = { title: "Membership checkout complete", robots: { index: false } };
...
export default async function MembershipSuccessPage() {
  ...
  return (
    <MembershipStatusPage
      ...
      title={active ? "Welcome to DayTradingPost Premium." : "Your payment is being confirmed."}
      description={active
